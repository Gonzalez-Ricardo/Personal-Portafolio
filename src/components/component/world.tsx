...
export function GlobeDemo() {
  ...
  const colors = ["#06b6d4", "#ffffff", "#6366f1"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div className="flex flex-row items-center justify-center py-5 h-auto md:h-auto dark:bg-black  relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        <div className=" w-full -bottom-10 h-72 md:h-full z-10">
